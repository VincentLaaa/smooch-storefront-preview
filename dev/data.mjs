...
const FIXTURES = {
  'smooch-daily-gummies-qa': {
    ...
    media: [
      { src: '/assets/smooch-demo-hero-editorial.jpg', alt: "Smooch Women's Libido & Mood bottle among blush sculptural forms on a deep berry backdrop", width: 1200, height: 1600 },
