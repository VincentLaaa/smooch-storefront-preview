...
const FIXTURES = {
  'smooch-daily-gummies-qa': {
    ...
    media: [
      { src: '/assets/smooch-demo-hero-annotated.png', alt: "Smooch Women's Libido & Mood bottle with hand-written callouts: easy 2-gummy routine, 60 daily gummies, clean daily formula", width: 505, height: 555 },
