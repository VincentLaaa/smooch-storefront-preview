...
const FIXTURES = {
  'smooch-daily-gummies-qa': {
    ...
    media: [
      { src: '/assets/smooch-demo-hero-editorial.png', alt: "Smooch Women's Libido & Mood bottle floating with watermelon gummies against the page background", width: 1024, height: 1024 },
